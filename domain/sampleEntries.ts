...
import { newEntry, sortByCreatedAt } from './Entry';

const baseDate = parseISO('2023-06-23T02:25:00+09:00');

export const sampleEntries = sortByCreatedAt([
  newEntry({
  ...
  newEntry({
    ...
    tags: ['文学', '夏目漱石'],
    createdAt: subDays(baseDate, 1).toISOString(),
  ...
  newEntry({
    ...
    tags: ['哲学', 'ヒューム'],
    createdAt: subDays(baseDate, 3).toISOString(),
  ...
  newEntry({
    ...
    tags: ['政治'],
    createdAt: subDays(baseDate, 7).toISOString(),
  ...
  newEntry({
    ...
    tags: ['文学', '太宰治'],
    createdAt: subDays(baseDate, 14).toISOString(),
    starred: true,
  ...
  newEntry({
    ...
    tags: ['哲学', '西田幾多郎', 'デカルト'],
    createdAt: subDays(baseDate, 28).toISOString(),
  ...
  newEntry({
    ...
    tags: ['文学', '太宰治'],
    createdAt: subDays(baseDate, 60).toISOString(),
  ...
  newEntry({
    ...
    tags: ['文学', '島崎藤村'],
    createdAt: subDays(baseDate, 120).toISOString(),
  ...
  newEntry({
    ...
    tags: ['文学', '夏目漱石'],
    createdAt: subDays(baseDate, 240).toISOString(),
